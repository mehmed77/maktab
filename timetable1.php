        ...
        <div class="alert alert-danger" style="text-transform: uppercase; text-align: center; color: #080808;">
            ...
            <b class="pull-right">
                <a href="timetable.php">
                    <button class="btn btn-sm btn-info" style="color: black">Boshlang'ich Sinflar Uchun <span style="color: red"> >> </span></button>
                </a>
            </b>
        </div>
    </div>
    <div class="col-xs-12">
                <table class="table table-bordered table-striped text-center">
                    <thead style="background: rgba(92, 153, 244, 0.8);">
                        <?php
                            $sql_sinf = mysql_query("SELECT * FROM `sinflar` WHERE `type` = 2 ORDER BY `sinf` ASC");
